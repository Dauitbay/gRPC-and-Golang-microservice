...
const file_orders_proto_rawDesc = "" +
	...
	"\fOrderService\x128\n" +
	"\vCreateOrder\x12\x13.CreateOrderRequest\x1a\x14.CreateOrderResponse\x122\n" +
	"\tGetOrders\x12\x11.GetOrdersRequest\x1a\x12.GetOrdersResponseB$Z\"github.com/sikozonpc/common/ordersb\x06proto3"
